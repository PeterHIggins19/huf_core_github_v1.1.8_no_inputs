# HUF-DOC: HUF.DRAFT.PARTNER.NOTE.RAMSAR_HUF_DEMO_V2 | HUF:1.1.8 | DOC:v2 | STATUS:draft | LANE:DRAFT | RO:Peter Higgins
# CODES: RMS | ART: CM, AS, TR, EB | EVID:E1 | POSTURE:OP | WEIGHTS: OP=0.51 TOOL=0.49 PEER=0.00 | CAP: OP_MIN=0.51 TOOL_MAX=0.49 | CANON:notes/current_documents/staged/HUF.DRAFT.PARTNER.NOTE.RAMSAR_HUF_DEMO_V2/ramsar_huf_demo_v2.py
