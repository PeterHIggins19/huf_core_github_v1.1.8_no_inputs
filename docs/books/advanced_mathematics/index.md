HUF-DOC: HUF.DRAFT.BOOK.MANUSCRIPT.ADVANCED_MATH | HUF:1.1.8 | DOC:v0.2.0 | STATUS:draft | LANE:draft | RO:Peter Higgins
CODES: BOOK, MATH, ADVANCED | ART: CM, AS, TR, EB | EVID:E0 | POSTURE:OP | WEIGHTS: OP=0.80 TOOL=0.20 PEER=0.00 | CAP: OP_MIN=0.51 TOOL_MAX=0.49 | CANON:docs/books/advanced_mathematics/index.md
